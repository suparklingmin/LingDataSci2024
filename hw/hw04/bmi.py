...
height = height # [Q5] EDIT THIS LINE

# convert pound to kilogram
weight = weight # [Q6] EDIT THIS LINE

# calculate BMI (Body mass index)
bmi = np.array() # [Q7] EDIT THIS LINE

print('who has the lowest BMI:', bmi.argmin()) # [Q8] Write the result
